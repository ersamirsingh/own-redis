...
import { Database, KeyRound, Loader2, Lock, Mail } from "lucide-react";
    ...
    <div className="min-h-screen bg-neutral-950 flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center space-y-2">
          ...
          <h1 className="text-2xl font-extrabold tracking-tight text-white">Sign In to PyRedis</h1>
          <p className="text-sm text-neutral-400">
            Access the operational data console and AI diagnostics
          </p>
        </div>
        ...
        <div className="bg-neutral-900 border border-neutral-800 rounded-2xl p-6 sm:p-8 shadow-2xl space-y-6">
          ...
          <div className="pt-2 border-t border-neutral-800/80 text-center">
            <p className="text-xs text-neutral-400">
              ...
              <Link href="/signup" className="text-red-400 hover:text-red-300 font-semibold underline underline-offset-2">
                Create an account
              </Link>
            </p>
          </div>
        ...
        <div className="text-center text-xs text-neutral-500 flex items-center justify-center gap-1.5">
          ...
          <span>Secured with Argon2id cryptographic hashing & JWT rotation</span>
        </div>
      </div>
    </div>
  );
